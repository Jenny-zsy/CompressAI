...
class HyperCompress1(nn.Module):
    ...
    def __init__(self,
                 ...
                 channel_M=192,
                 channel_out=3):
        super(HyperCompress1, self).__init__()
