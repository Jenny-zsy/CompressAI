...
from models.ca import SEBlock, ECABlock, CBAM_channel, CBAM_spatial
...
class Encoder(nn.Module):
    ...
    def __init__(self,
        ...
        self.ca1 = CBAM_channel(channel_mid)
        ...
        self.ca2 = CBAM_channel(channel_out)
...
class Decoder(nn.Module):
    ...
    def __init__(self, channel_in=192, channel_mid=128, channel_out=3):
        ...
        self.ca1 = CBAM_channel(channel_in)
        ...
        self.ca2 = CBAM_channel(channel_mid)
...
class HyperEncoder(nn.Module):
    ...
    def __init__(self, channel_in=192, channel_out=192):
        ...
        self.ca = CBAM_channel(channel_out)
...
class HyperDecoder(nn.Module):
    ...
    def __init__(self, channel_in=192, channel_mid=192):
        ...
        self.conv2 = nn.Sequential(
            ...
            nn.PixelShuffle(2))
        self.ca = CBAM_channel(channel_mid)
...
class HyperCompress3(nn.Module):
    ...
    def __init__(self,
                 ...
                 channel_M=192,
                 channel_out=3):
        super(HyperCompress3, self).__init__()
